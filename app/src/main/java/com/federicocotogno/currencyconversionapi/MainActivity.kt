...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Buttons
        val btnChange = findViewById<View>(R.id.btn) as Button

        // view products click event
        btnChange.setOnClickListener { // Launching All products Activity
            val i = Intent(applicationContext, tConv::class.java)
            startActivity(i)
        }
    }
    ...
    private fun getApiResult() {
        if (et_firstConversion != null && et_firstConversion.text.isNotEmpty() && et_firstConversion.text.isNotBlank()) {
            ...
            var API = "https://api.exchangerate.host/convert?from=$baseCurrency&to=$convertedToCurrency"
    ...
    private fun spinnerSetup() {
        ...
        ArrayAdapter.createFromResource(this, R.array.currencies2, android.R.layout.simple_spinner_item).also {
                adapter ->
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
